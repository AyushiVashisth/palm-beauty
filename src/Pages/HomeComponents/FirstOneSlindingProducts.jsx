...
function FirstOneSlindingProducts() {
  let crauserData = [
    ...
    {
      image:
        "https://media6.ppl-media.com/tr:w-1280,c-at_max,pr-true,dpr-2,f-gif/mediafiles/ecomm/misc/1674109513_rose-hip_web_category-1.gif",
    },
    {
      image:
    ...
    {
      image:
        "https://media6.ppl-media.com/tr:w-1280,c-at_max,pr-true,dpr-2/mediafiles/ecomm/misc/1673969537_mcaffeine_moisturize-2596x836-1.jpeg",
    },
    {
      image:
  ...
  console.log(imageState);
  return (
    <Box id="container_Client" pt={5} width={"85%"} margin={"auto"}>
      <br />
      <br />
      <br />
